...
export function createOpenApiSpec(version = '0.1.0'): OpenApiSpec {
  ...
  add('get', '/v1/radar/benchmarks/audio-speech-transcription', radarGet('Radar Readiness', 'Get audio speech transcription benchmark scaffold', 'Returns the audio-ai speech-transcription Benchmark Scaffold. benchmark_recorded=false means no five-run artifact is recorded and no route winner can be inferred.', { $ref: '#/components/schemas/BenchmarkDetailResponse' }, { benchmark_id: 'audio-speech-transcription', category: 'audio-ai', benchmark_intent: 'transcribe the same short audio fixture into normalized text', winner_claimed: false, benchmark_recorded: false, winner_status: 'not_evaluated', next_step: 'publish one stable public canonical audio fixture, finalize lane-specific normalizer/caveats/evidence_health policy, paid-prove two comparable transcription routes against the same fixture, then record one five-run benchmark artifact', readiness_note: 'Benchmark Scaffold. Canonical phrase: INFOPUNKS RADAR / EVIDENCE BEFORE SPEND / AUDIO BENCHMARK 001. Canonical fixture plan: https://radar.infopunks.fun/fixtures/audio-benchmark-001.wav (fallback: https://radar.infopunks.fun/fixtures/audio-benchmark-001.mp3). Research/readiness in Agent Harness recommends scaffold_ready, but promotion is blocked until fixture stability, lane normalization policy, two paid-proven comparable routes, and one five-run artifact exist.', routes: [] }));
