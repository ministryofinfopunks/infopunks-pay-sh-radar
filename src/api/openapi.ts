...
export function createOpenApiSpec(version = '0.1.0'): OpenApiSpec {
  ...
  }), { count: 3, mappings: [{ provider_name: 'StableCrypto', mapping_status: 'verified', execution_evidence_status: 'proven' }, { provider_name: 'CoinGecko Onchain DEX API', benchmark_intent: 'token search', mapping_status: 'verified', execution_evidence_status: 'proven' }] }));
