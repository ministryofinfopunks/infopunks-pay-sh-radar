...
export function createOpenApiSpec(version = '0.1.0'): OpenApiSpec {
  ...
  add('get', '/v1/4663/reflexive/audits/long-ai-nvda', rh4663('Inspect LONG AI/NVDA audit boundary', 'Returns independently checked canonical quote and V4 pool identity. It returns unavailable inventory unless LONG’s liquidity container and positions are independently enumerable; public index context is not factory provenance.', 'ReflexiveLongAudit', { market: { venue: 'LONG', identity_status: 'VERIFIED' }, inventory: { status: 'UNAVAILABLE', failure: 'LIQUIDITY_CONTAINER_UNRESOLVED' } }));
