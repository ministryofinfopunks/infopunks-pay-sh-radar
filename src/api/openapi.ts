...
export function createOpenApiSpec(version = '0.1.0'): OpenApiSpec {
  ...
  add('get', '/v1/4663/reflexive/watch', rh4663('Get Reflexive Markets Watch', 'Returns the public WATCH to RADAR evidence bridge. Watch claims are provenance-scoped discovery objects and Watch verdicts are WATCH_INTERPRETATION, never RADAR_VERDICT. The feed cannot create verified inventory, verified supply, verified pool provenance, thesis confirmation, or protocol receipts.', 'ReflexiveMarketsWatch', { object_type: 'REFLEXIVE_MARKETS_WATCH', doctrine: ['WATCH_DISCOVERS', 'RADAR_VERIFIES'], feed: [], falsification_queue: [], thesis_board: [] }));
  ...
  add('get', '/v1/4663/reflexive/watch/cases/{id}', rh4663('Get RWA Activation Case', 'Returns one case with WHAT HAPPENED, Watch interpretation, claims, Radar evidence links, persistence, falsification criteria, open gaps, thesis impact, and append-only state transitions. No trading CTA or token recommendation is exposed.', 'RwaActivationCaseDetail', { case: { case_id: 'AI_NVDA_CAPITAL_VS_FLOW', object_type: 'RWA_ACTIVATION_CASE' }, claims: [], audit_targets: [] }, undefined, [pathParam('id', 'RWA Activation Case identifier.')]));
