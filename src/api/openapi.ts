...
export function createOpenApiSpec(version = '0.1.0'): OpenApiSpec {
  ...
  }), { count: 10, targets: [{ category: 'solana-infra', benchmark_intent: 'account balance', current_state: 'needs_two_comparable_mappings' }, { category: 'document-ai', benchmark_intent: 'document OCR text extraction', current_state: 'needs_two_comparable_mappings' }] }));
