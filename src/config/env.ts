...
export function deploymentSummary(config: RuntimeConfig) {
  return {
    ...
    ipxPltrShadowObservation: {
      enabled: config.ipxPltrShadowObservationEnabled,
      intervalMs: config.ipxPltrShadowObservationIntervalMs,
      capacitySweepEnabled: config.ipxPltrShadowCapacitySweepEnabled
    },
