...
export function assembleRhChainDistributionPack(receipt = getRhChainDailyReceipts().latest_receipt): RhChainDistributionPackPayload {
  ...
  const packets: RhChainDistributionPacket[] = [
    ...
    { id: 'submit-signal', title: 'Submit Signal call-to-action', intended_surface: 'generic', copy_text: `Got a contract, pair, launch source, deployer trail, or risk receipt?\n\nSubmit it to the RH Chain Signal Vault.\n\nManual review. No auto-approval. No receipt, no signal.`, link: `${BASE}/submit`, risk_disclaimer: 'Submission is not endorsement, listing, partnership, or financial advice.', last_updated: desk.generated_at, source_artifact: 'Signal Vault' },
