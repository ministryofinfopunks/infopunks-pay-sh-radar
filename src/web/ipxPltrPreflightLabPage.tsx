  ...
  return <div className="ipx-lab-shell">
    ...
    <main className="ipx-lab-main">
      ...
      <section className="ipx-shadow-lab" aria-label="Shadow Lab">
        <header><span>IPX / PLTR PREFLIGHT LAB v0.5.1</span><h2>SHADOW LAB</h2><p>Pinned designs replay unchanged against explicit READY PLTR states. Research only—economic architecture first, venue implementation later.</p></header>
        ...
        <div className="ipx-shadow-frontier"><div><span>IDENTITY MARKET EFFICIENCY</span><h3>CONCENTRATION /<br />CAPACITY FRONTIER</h3><p>IME tracks modeled usable capacity per percentage point of first-party PLTR concentration. It is not a token score, recommendation, or venue decision.</p></div><div className="ipx-frontier-axis"><i>MODELED USABLE MARKET CAPACITY ↑</i><b>•</b><b>•</b><b>•</b><small>FIRST-PARTY PLTR CONCENTRATION →</small></div></div>
