...
describe('public benchmark proof pages', () => {
  ...
  it('renders benchmark registry page and benchmark proof link', async () => {
    ...
    expect(text).toContain('winner_claimed=falsemeans agents should not infer route superiority.');
    ...
    expect(text).not.toMatch(/best route|fastest route|safest route|recommended route/i);
