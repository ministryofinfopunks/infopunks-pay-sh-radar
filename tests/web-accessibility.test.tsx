    ...
    vi.spyOn(globalThis, 'fetch').mockImplementation((input) => {
      ...
      if (path === '/v1/radar/mapping-targets') return json({
        ...
        targets: [
          ...
          { category: 'finance/data', benchmark_intent: 'token search', current_state: 'one_proven_mapping_found', needed_next_step: 'Add and prove a second comparable token-search route.', suggested_provider_candidates: ['CoinGecko Onchain DEX API'], why_it_matters: 'Search intent supports benchmark input shaping.', readiness_blocker: 'One proven route exists, but benchmark readiness requires two comparable proven routes.' },
