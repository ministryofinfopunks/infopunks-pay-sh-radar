    ...
    vi.spyOn(globalThis, 'fetch').mockImplementation((input) => {
      ...
      if (path === '/v1/radar/mapping-targets') return json({
        ...
        targets: [
          ...
          { category: 'finance/data', benchmark_intent: 'token search', current_state: 'candidate_mapping_found', needed_next_step: 'Verify endpoint/method/response shape and run paid execution only when ready.', suggested_provider_candidates: ['CoinGecko Onchain DEX API'], why_it_matters: 'Search intent supports benchmark input shaping.', readiness_blocker: 'Candidate route exists, but paid execution proof is not recorded.' },
