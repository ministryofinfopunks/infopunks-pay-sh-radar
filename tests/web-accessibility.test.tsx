    ...
    vi.spyOn(globalThis, 'fetch').mockImplementation((input) => {
      ...
      if (path === '/v1/radar/mapping-targets') return json({
        ...
        targets: [
          ...
          { category: 'finance/data', benchmark_intent: 'token search', current_state: 'verified_mapping_found', needed_next_step: 'Run paid execution only when ready to produce proven evidence.', suggested_provider_candidates: ['CoinGecko Onchain DEX API'], why_it_matters: 'Search intent supports benchmark input shaping.', readiness_blocker: 'Verified route exists, but paid execution proof is not recorded.' },
