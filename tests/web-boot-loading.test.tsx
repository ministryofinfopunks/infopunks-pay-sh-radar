...
describe('radar boot loading behavior', () => {
  ...
  it('API timeout exits boot state', async () => {
    ...
    expect(container.textContent).toContain('INFOPUNKS RADAR // SOLANA INTELLIGENCE BOOTING...');
    ...
    expect(container.textContent).not.toContain('INFOPUNKS RADAR // SOLANA INTELLIGENCE BOOTING...');
